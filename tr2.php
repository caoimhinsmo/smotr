...
EOD_duilleaganHtml;
            ...
            foreach ($traArr as $traRow) {
                ...
                $HTML .= "<tr><td><span id=\"$id-$t-changed\" class=change>✔<span></td>"
                       . "<td$soillsStyle>$t</td>"
                       . "<td><textarea$soillsichCananStyle onchange=\"atharraichTra('$id','$t',this.value)\" lang=\"$t\">$traHtml</textarea></td>"
            ...
            $HTML .= "<tr id='$id-tur-row'><td><span id='$id-tur-changed' class=change>✔<span></td>"
                   ...
                   . "<td><textarea id='$id-tur-tra' onchange=cruthaichTra('$id')></textarea></td>"
                   . "<td></td></tr>\n";
            $HTML .= "</table>\n";
            $HTML .= "</div>\n";
        }
...
<head>
    ...
    <style>
        ...
        textarea { width:100%; height:30px; font-family:Verdana,Helvetica,sans-serif; }

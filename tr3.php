...
EOD_duilleaganHtml;
            ...
            foreach ($traArr as $traRow) {
                ...
                $HTML .= "<tr><td><span id=\"$id-$t-changed\" class=change>✔<span></td>"
                       . "<td$soillsStyle>$t</td>"
                       . "<td><p$soillsichCananStyle contenteditable=true onchange=\"atharraichTra('$id','$t',this.value)\" lang=\"$t\">$traHtml</p></td>"
            ...
            $HTML .= "<tr id='$id-tur-row'><td><span id='$id-tur-changed' class=change>✔<span></td>"
                   ...
                   . "<td><p id='$id-tur-tra' contenteditable=true onchange=cruthaichTra('$id')></p></td>"
                   . "<td></td></tr>\n";
            $HTML .= "</table>\n";
            $HTML .= "</div>\n";
        }
...
<head>
    ...
    <style>
        ...
        p[contenteditable=true] { margin:0; background-color:white; border:1px solid black; min-height:1.2em; font-family:Verdana,Helvetica,sans-serif; }
